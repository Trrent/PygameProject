...
class FlyingEntity(BaseEntity):
    def __init__(self, pos: Point, hor_vel: float, ver_vel: float, damage_cd: float, health: int, damage: int, jump_height: float):
        super().__init__(pos, hor_vel, damage_cd, health, damage)
        self.ver_vel = ver_vel


class Skeleton(GroundEntity, Sprite):
    def __init__(self, pos: Point, player, hor_vel=4, damage_cd=3, health=70, damage=15, jump_height=100):
...
class FireSpirit(GroundEntity, Sprite):
    def __init__(self, pos: Point, player, hor_vel=6, damage_cd=3, health=70, damage=15, jump_height=100):
        GroundEntity.__init__(self, pos, hor_vel, damage_cd, health, damage, jump_height)
        Sprite.__init__(self, all_sprites, enemies)
        self.frames = {'AttackRight': (8, 1, []), 'AttackLeft': (8, 1, []), 'DeathRight': (4, 1, []),
                       'DeathLeft': (4, 1, []), 'HitRight': (4, 1, []), 'HitLeft': (4, 1, []), 'IdleRight': (4, 1, []),
...
class Slime(GroundEntity, Sprite):
    def __init__(self, pos: Point, player, hor_vel=2, damage_cd=3, health=70, damage=15, jump_height=100):
        GroundEntity.__init__(self, pos, hor_vel, damage_cd, health, damage, jump_height)
        Sprite.__init__(self, all_sprites, enemies)
        self.frames = {'AttackRight': (8, 1, []), 'AttackLeft': (8, 1, []), 'DeathRight': (4, 1, []),
                       'DeathLeft': (4, 1, []), 'HitRight': (4, 1, []), 'HitLeft': (4, 1, []), 'IdleRight': (4, 1, []),
...
class Wizard(GroundEntity, Sprite):
    def __init__(self, pos: Point, player, hor_vel=5, damage_cd=3, health=300, damage=15, jump_height=100):
        GroundEntity.__init__(self, pos, hor_vel, damage_cd, health, damage, jump_height)
        Sprite.__init__(self, all_sprites, enemies)
        self.frames = {'AttackRight': (8, 1, []), 'AttackLeft': (8, 1, []), 'DeathRight': (4, 1, []),
                       'DeathLeft': (4, 1, []), 'HitRight': (4, 1, []), 'HitLeft': (4, 1, []), 'IdleRight': (4, 1, []),
...
class Bat(FlyingEntity, Sprite):  # TODO сменить на шаблон FlyingEntity, убрать гравитацию
    def __init__(self, pos: Point, player, hor_vel=6, ver_vel=6, damage_cd=3, health=70, damage=15, jump_height=100):
        FlyingEntity.__init__(self, pos, hor_vel, ver_vel, damage_cd, health, damage, jump_height)
        Sprite.__init__(self, all_sprites, enemies)
        self.frames = {'AttackRight': (8, 1, []), 'AttackLeft': (8, 1, []), 'DeathRight': (4, 1, []),
                       'DeathLeft': (4, 1, []), 'HitRight': (4, 1, []), 'HitLeft': (4, 1, []), 'IdleRight': (4, 1, []),
                       'IdleLeft': (4, 1, []), 'WalkRight': (4, 1, []), 'WalkLeft': (4, 1, [])}
    ...
    def update(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.pos.x += self.cur_vel.i * self.hor_vel
        self.pos.y += self.cur_vel.j * self.ver_vel
        self.pos.upd()
